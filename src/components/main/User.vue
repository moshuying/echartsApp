    ...
    <div class="main">
            ...
            <div class="next">
                <div class="checkbox">
                    <select name="" id="">
                        ...
                        <option value="">买出</option>
                        <option value="">全部交易</option>
                    </select>
                </div>
                <div class="time">
                    <p id="navtime">2019年01月</p>
                </div>
            </div>
        </header>
        <div class="timeNav" onclick="jumpclick()" id="start_date">
            <!-- 这里会取导航栏上的时间 -->
        ...
        <div class="infobox">
            <div class="line">
                ...
                <div class="right">
                    <span class="passages">+10.00</span>
                </div>
            </div>
            <div class="line">
                <div class="lineicon">
...
<style scoped>
    ...
    header .next .checkbox {
        display: inline;
        display: flex;
    }

    header .next .checkbox select {
        width: 3rem;
        display: inline;
        appearance: none;
        -moz-appearance: none;
        ...
        border: none;
        background: url("./images/search_arrow.gif")no-repeat scroll right center transparent;
    }
    ...
    .timeNav {
        ...
        justify-content: center;
        align-items: center;
        background: linear-gradient(90deg, #187ABF, #3BCC8A);
    }
    ...
    .infobox .line .right .passages {
        color: #2eaba8;
    }

    .infobox .line .lineicon {
        width: 10rem;
        display: flex;
        justify-content: space-between;
    }

    .infobox .line .lineicon .icon {
        width: 2rem;
        height: 2rem;
        background: url("./images/lineicon.svg") no-repeat center center;
